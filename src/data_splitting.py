...
on the representation this pipeline actually produces (-0.0017 ROC-AUC averaged
over the four base models, at 1.7-2.7x the training time), so it was removed
